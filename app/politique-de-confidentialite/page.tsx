...
export default function PolitiqueConfidentialite() {
  return (
    <section className="politique px-5 space-y-6 w-full font-raleway text-white pb-20 md:px-10">
      ...
      <p className="text-base md:text-lg xl:text-xl">
        Chez WebCreatis, nous accordons une grande importance à la protection de
        vos données personnelles. Cette politique de confidentialité explique
        comment nous recueillons, utilisons et protégeons les informations que
      ...
      <p className="text-base md:text-lg xl:text-xl">
        ...
        vous envoyer des communications pertinentes concernant nos services. Vos
        informations peuvent également être utilisées à des fins internes telles
        que l’analyse statistique, l’amélioration de nos services et la
      ...
      <p className="text-base md:text-lg xl:text-xl">
        Nous prenons toutes les mesures nécessaires pour assurer la sécurité et
        la confidentialité de vos données personnelles. Nous utilisons des
      ...
      <div className="text-base md:text-lg xl:text-xl">
        ...
        <ul className="list-disc list-inside mt-2 ml-4">
          ...
          <li>
            Si cela est nécessaire pour répondre à une obligation légale ou pour
            protéger nos droits, notre propriété ou notre sécurité, ainsi que
            ceux de nos utilisateurs ou du public.
          </li>
        </ul>
      </div>
      ...
      <p className="text-base md:text-lg xl:text-xl">
        ...
        confidentialité ou du contenu de ces sites Web. Nous vous encourageons à
        lire les politiques de confidentialité de ces sites tiers avant de
      ...
      <p className="text-base md:text-lg xl:text-xl">
        Nous ne conservons vos données personnelles que le temps nécessaire pour
        atteindre les finalités pour lesquelles elles ont été collectées, sauf
        si la loi nous oblige à les conserver plus longtemps.
      </p>
      ...
      <p className="text-base md:text-lg xl:text-xl">
        ...
        notre politique de confidentialité, veuillez nous contacter en utilisant
