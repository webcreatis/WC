  ...
  return (
    <div className="relative overflow-hidden w-full h-[200px] xs:h-[350px] sm:h-[300px] md:h-[400px] lg:h-[500px]">
      ...
      <div className="absolute flex animate-scroll whitespace-nowrap will-change-transform">
        <span className="px-4 sm:px-8 text-[120px] xs:text-[400px] sm:text-[200px] md:text-[300px] lg:text-[500px] uppercase text-white font-jaapokki font-light leading-none">
          créasite
        </span>
        <span className="px-4 sm:px-8 text-[120px] sm:text-[200px] md:text-[300px] lg:text-[500px] uppercase text-white font-jaapokki font-light leading-none">
          créasite
        </span>
      </div>
    </div>
