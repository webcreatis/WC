...
export default function Meteo() {
  ...
  return (
    <div className="w-[30%] clock border-[1px] border-[#3f3f46] rounded-xl overflow-hidden gap-7 p-5 text-white font-michroma shadow-[0_5px_5px_-5px_rgba(212,212,212,0.2),0_5px_5px_-6px_rgba(212,212,212,0.2)] bg-[radial-gradient(circle,hsla(0,0%,100%,0.1) 0,hsla(0,0%,100%,0) 50%)] xs:hidden tablet:flex">
