    ...
    <section className="services w-full h-auto flex-col justify-start items-start">
      ...
      <div className="w-full h-auto pb-32">
        <ul className="w-3/4 m-auto">
          <li
            className="flex w-full border-b-[1px] border-white mt-5 box"
      ...
      <div
        ref={cursorRef}
        className="cursor w-[20px] h-[20px] rounded-full bg-green border-2 border-white border-solid fixed pointer-events-none bg-contain bg-center"
      ></div>
    </section>
  );
}
