...
const packs = [
  ...
  },
  {
    ...
    price: "320€ - 560€/mois",
    description:
      "2 sessions/semaine (1h - 1h30). Suivi poussé, code review, préparation certification, projets concrets.",
  },
  {
    title: "Pack Premium",
    price: "600€ - 1 080€/mois",
    description:
      "3 sessions/semaine (1h30 - 2h). Suivi intensif, simulations, portfolio, ressources exclusives.",
  },
  {
    title: "À la Demande",
    price: "40€ - 80€/h",
    description:
      "Sessions ponctuelles à réserver à l'avance selon besoins spécifiques.",
  },
  {
    title: "Forfait Projet",
    price: "400€ - 1 000€",
    description:
      "Accompagnement complet sur un projet (10-15h), conseils, révision, suivi personnalisé.",
  },
];
