...
export const reviews = [
  ...
  {
    date: "3 Mai 2025",
    quote: `J'ai fait appel à Patrick pour la mise à jour et l'amélioration de mon site web Wordpress et il a été de très bons conseils. 
  ...
  },
  {
    ...
    quote: `Un grand merci à Webcreatis pour leur excellent travail dans la création de notre portail web ainsi que pour la maintenance et mise à jour de notre site web. 
  ...
  },
  {
    ...
    quote: `Des professionnels complémentaires dans leurs compétences à votre service et à votre écoute. 
  ...
  {
    date: "6 mai 2024",
    quote: `Patrick et Patricia sont très professionnels. Ils ont le soucis du travail bien fait, ils sont disponibles, patients, à l’écoute, et de très bons conseils. 
  ...
  },
  {
    ...
    quote: `Patrick a un sens du beau très prononcé surtout quand il est question de créer de belles interfaces utilisateurs ergonomiques qui engagent les prospects de son client. 
  ...
  },
  {
    ...
    quote: `N’ hésitez pas à confier votre site et votre communication sur le Web à l’équipe de Webcreatis!
  ...
  {
    date: "25 septembre 2023",
    quote: `Je tiens à exprimer ma profonde gratitude envers WEBCREATIS, pour leur remarquable travail dans la création de mon site internet.
