...
const config: Config = {
  ...
  theme: {
    extend: {
      content: {
        infos:
          'Création site internet - Social Network - Formation - Développement sur mesure"',
      },
      screens: {
        xs: "320px",
        s: "375px",
      ...
      animation: {
        ...
        SlideDownDeform:
          "SlideDownDeform 0.8s cubic-bezier(0.8, 0, 0.2, 1) forwards",
